      ...
      >
        <div className="max-w-7xl mx-auto px-4 pt-24 pb-14">
          ...
          <h1 className="mt-4 text-4xl md:text-5xl font-bold leading-[1.1] text-slate-900">
            Get a project <span className="text-emerald-600">estimate</span>
          </h1>
          <p className="mt-3 text-lg text-slate-600 max-w-3xl">
            Share your scope, budget range, and timeline. We’ll reply with a
            plan.
          </p>
        </div>
        <svg
        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-10">
          ...
          >
            ...
            <input
              type="hidden"
              name="subject"
              value="Get a Quote — Code Sangraha"
            />
            ...
            <input
              ...
              className="mt-5 w-full border border-slate-200 rounded-lg p-3"
            />
            ...
            <textarea
              name="message"
              rows="6"
              placeholder="Describe the scope, features, and success metrics"
              className="mt-5 w-full border border-slate-200 rounded-lg p-3"
              required
            ></textarea>
